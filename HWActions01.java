...
//        Assert.assertTrue(driver.findElement(By.xpath("//*[text()='New Tab']")).isDisplayed());
       ...
       // driver.findElement(By.xpath("(//div[@class='card mt-4 top-card'])[3]")).click();
        ...
        //""Please select an item from left to start practice."" yazısının görünür olduğunu doğrula
        WebElement verify = driver.findElement(By.xpath("//div[text()='Please select an item from left to start practice.']"));
        ...
        //New Tab butonunun görünür olduğunu doğrula
        Assert.assertTrue(driver.findElement(By.xpath("//button[text()='New Tab']")).isDisplayed());
